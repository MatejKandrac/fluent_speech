...
\begin{enumerate}
    ...
    \item Mal váhy hodnotenia dimenzií podložené empirickým výskumom vnímania prezentácií
\end{enumerate}
...
Moje riešenie sa preto zameriava na vytvorenie takéhoto komplexného systému, ktorý eliminuje uvedené medzery existujúcich riešení. Súčasťou práce je aj \textbf{empirická výskumná štúdia} ($n = 47$ respondentov), ktorá overuje, do akej miery jednotlivé dimenzie prezentácie ovplyvňujú celkové vnímanie jej kvality, a či časová distribúcia negatívnych javov hrá rolu vo vnímaní ich závažnosti. Výsledky tejto štúdie boli priamo zapracované do hodnotiacich váh systému. Štúdia je podrobne popísaná v kapitole~\ref{chap:vyskum}.