...
Zároveň sa dá využiť logické členenie z tohto pravidla, konkrétne, že vieme rozdeliť komunikáciu do troch kategórií:
\begin{itemize}
    \item Verbálne
...
Pri využívaní svojho hlasu je potrebné dávať si pozor hneď na niekoľko jeho vlastností. Túto problematiku opisoval v rámci svojej prednášky Julian Treasure\cite{voice} a poukázal na tieto hlasové vlastnosti:
\begin{itemize}
...
Systém analyzuje:
\begin{itemize}
    \item \textbf{Postoj} --- pomocou BlazePose (MediaPipe) extrahuje kľúčové body tela a klasifikuje ich do piatich posturálnych kategórií (ruky otvorené, ruky dole, ruky v bok atď.) pomocou natrénovanej doprednej neurónovej siete
