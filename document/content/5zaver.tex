...
Tieto zistenia boli priamo zapracované do hodnotiaceho modelu. Aktualizácia váh dimenzií z pôvodných odhadov na hodnoty odvodené z regresných koeficientov zvýšila Spearmanovu koreláciu modelu s ľudskými hodnoteniami z $\rho = 0{,}754$ na $\rho = 0{,}928$. Model v3 ďalej rozšíril hodnotenie plynulosti o penalizáciu za rovnomernú distribúciu výplňových slov.
