...
class _VideoApiClient implements VideoApiClient {
  _VideoApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<VideoUploadResponse> uploadVideo({
    ...
    final _options = _setStreamType<VideoUploadResponse>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    late VideoUploadResponse _value;
    try {
      _value = VideoUploadResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
